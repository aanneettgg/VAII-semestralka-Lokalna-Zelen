    ...
    <div class="container">
        <div class="col-sm-4 offset-sm-4">
            ...
            <form method="post" action="?c=company&a=createCompany" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Názov firmy</label>
                ...
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Popis firmy</label>
                    <input type="text" class="form-control" name="companyDescription" value="<?= $data['company']->companyDescription ?? "" ?>" maxlength="500" placeholder="Popis firmy" required>
                </div>
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Logo firmy</label>
