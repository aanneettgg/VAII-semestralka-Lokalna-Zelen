    ...
    <div class="container">
        <form method="post" action="?c=user&a=updateUser&id">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="username" placeholder="Používateľské meno" value="<?= $data['user']->username ?? "" ?>">
            </div>
            <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label">Meno</label>
                <input type="text" class="form-control" name="name" placeholder="Meno" value="<?= $data['user']->name ?? "" ?>">
            </div>
            <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label">Priezvisko</label>
                <input type="text" class="form-control" name="surname" placeholder="Priezvisko" value="<?= $data['user']->surname ?? "" ?>">
            </div>
            <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label">Heslo</label>
                <input type="password" class="form-control" name="password" placeholder="Heslo" value="<?= $data['user']->password ?? "" ?>">
            </div>
            <div class="mb-3">
